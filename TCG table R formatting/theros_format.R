setwd("/Users/efridge123/Desktop/R/Directory/TCGspiders/theros")

filenames<-list.files(pattern =".csv")

for( i in 1:length( filenames ) ){
    
    ##transfer timestamp from filename to table
    x <- sub(pattern = "theros.csv", replacement = "2014", filenames[i], ignore.case = TRUE, perl = FALSE)
